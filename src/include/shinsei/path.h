...
_SHINSEI_LIB_API size_t shinsei_getUserDataPathU8(unsigned char *const buf,const size_t buf_len);
_SHINSEI_LIB_API unsigned char* shinsei_getUserDataPathU8B();
...
_SHINSEI_LIB_API size_t shinsei_getSystemDataPathU8(unsigned char *const buf,const size_t buf_len);
_SHINSEI_LIB_API unsigned char* shinsei_getSystemDataPathU8B();
