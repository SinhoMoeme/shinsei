...
_SHINSEI_LIB_API bool shinsei_stringToMappedIPv6A(register uint32_t*const restrict des,register const char*const restrict src,register const size_t src_len);

// Convert mapped IPv6 address to string
_SHINSEI_LIB_API size_t shinsei_mappedIPv6ToStringA(register char*const restrict des,register const uint32_t*const restrict src);
	...
	// Convert string to mapped IPv6 address
	_SHINSEI_LIB_API bool shinsei_stringToMappedIPv6N(register uint32_t*const restrict des,register const wchar_t*const restrict src,register const size_t src_len);

	// Convert mapped IPv6 address to string
	_SHINSEI_LIB_API size_t shinsei_mappedIPv6ToStringN(register wchar_t*const restrict des,register const uint32_t*const restrict src);
	...
	// Convert string to mapped IPv6 address
	_SHINSEI_LIB_API bool shinsei_stringToMappedIPv6N(register uint32_t*const restrict des,register const char8_t*const restrict src,register const size_t src_len);

	// Convert mapped IPv6 address to string
	_SHINSEI_LIB_API size_t shinsei_mappedIPv6ToStringN(register char8_t*const restrict des,register const uint32_t*const restrict src);
