...
namespace shinsei{
	...
	_SHINSEI_OS_INLINE ::size_t iPv4ToString(wchar_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv4ToStringW(des,src);
	}
	...
	_SHINSEI_OS_INLINE ::size_t iPv4ToString(char8_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv4ToStringU8(des,src);
	}
	...
	_SHINSEI_OS_INLINE ::size_t iPv4ToString(char16_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv4ToStringU16(des,src);
	}
	...
	_SHINSEI_OS_INLINE ::size_t iPv4ToString(char32_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv4ToStringU32(des,src);
	}
	...
	_SHINSEI_OS_INLINE bool stringToIPv6(::uint32_t*const restrict des,const wchar_t*const restrict src,const ::size_t src_len){
		return ::shinsei_stringToIPv6W(des,src,src_len);
	}
	...
	_SHINSEI_OS_INLINE bool stringToIPv6(::uint32_t*const restrict des,const char8_t*const restrict src,const ::size_t src_len){
		return ::shinsei_stringToIPv6U8(des,src,src_len);
	}
	...
	_SHINSEI_OS_INLINE bool stringToIPv6(::uint32_t*const restrict des,const char16_t*const restrict src,const ::size_t src_len){
		return ::shinsei_stringToIPv6U16(des,src,src_len);
	}
	...
	_SHINSEI_OS_INLINE bool stringToIPv6(::uint32_t*const restrict des,const char32_t*const restrict src,const ::size_t src_len){
		return ::shinsei_stringToIPv6U32(des,src,src_len);
	}
	...
	_SHINSEI_OS_INLINE ::size_t iPv6ToString(wchar_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv6ToStringW(des,src);
	}
	...
	_SHINSEI_OS_INLINE ::size_t iPv6ToString(char8_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv6ToStringU8(des,src);
	}
	...
	_SHINSEI_OS_INLINE ::size_t iPv6ToString(char16_t*const restrict des,const ::uint32_t*const restrict src){
		return ::shinsei_iPv6ToStringU16(des,src);
	}
