...
_SHINSEI_LIB_API bool shinsei_isBDigitU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isBDigitU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isODigitU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isODigitU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isDigitU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isDigitU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isXDigitU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isXDigitU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isUpperU8(const char8_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isLowerU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isLowerU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isAlphaU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isAlphaU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API bool shinsei_isAlnumU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API bool shinsei_isAlnumU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API char8_t shinsei_toUpperU8S(const char8_t**restrict str_ptr,const size_t len);
_SHINSEI_LIB_API char16_t shinsei_toUpperU16S(const char16_t**restrict str_ptr,const size_t len);
...
_SHINSEI_LIB_API int shinsei_utf32CharToUtf8Char(char8_t*restrict des,const char32_t src);
_SHINSEI_LIB_API int shinsei_utf16CharToUtf8Char(char8_t*restrict des,const char16_t*restrict src,const size_t src_len);

_SHINSEI_LIB_API int shinsei_utf16CharToUtf32Char(char32_t*restrict des,const char16_t* src,const size_t src_len);
_SHINSEI_LIB_API int shinsei_utf8CharToUtf32Char(char32_t*restrict des,const char8_t* src,const size_t src_len);
_SHINSEI_LIB_API int shinsei_utf8CharToUtf16Char(char16_t*restrict des,const char8_t* src,const size_t src_len);

_SHINSEI_LIB_API size_t shinsei_utf16ToUtf8(char8_t *restrict des,const size_t des_len,const char16_t *restrict src,const size_t src_len);
_SHINSEI_LIB_API char8_t* shinsei_utf16ToUtf8B(const char16_t *src,const size_t src_len);
